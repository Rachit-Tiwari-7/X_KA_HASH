...
start "Backend API" cmd /k "cd /d "%~dp0" && echo Backend starting... && "C:\Users\rachi\AppData\Local\Programs\Python\Python311\python.exe" -m uvicorn api.app:create_app --factory --host 127.0.0.1 --port 8000 --reload"
