...
export default function OrderBook({ symbol = '', levels = 12 }: OrderBookProps) {
  ...
  return (
    <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color)' }}>
      {!usingWsData && (
        <div style={{ padding: '2px 8px', fontSize: 9, fontFamily: "'JetBrains Mono', monospace", background: 'rgba(234,179,8,0.15)', color: 'var(--accent-yellow)', textAlign: 'center', borderBottom: '1px solid var(--border-color)' }}>
          ⚠ Using simulated orderbook data — not real L2 depth
        </div>
      )}
