...
function TerminalLayout() {
  ...
  const chartRoutes = ['/markets/chart', '/trading/chart', '/ai/persona-council', '/markets/compare', '/advanced-charts']
  const isChartRoute = chartRoutes.some(r => location.pathname.startsWith(r))
