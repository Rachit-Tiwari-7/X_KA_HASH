...
export const ROUTES: RouteConfig[] = [
  ...
  { path: '/ai/alpha-zoo', label: 'Alpha Zoo', group: 'ai', workflow: 'quant' },
  { path: '/ai/hypotheses-v2', label: 'Hypotheses V2', group: 'ai', workflow: 'researcher' },
  { path: '/ai/mcp', label: 'MCP', group: 'ai', workflow: 'quant' },
  { path: '/ai/renaissance', label: 'Renaissance', group: 'ai', workflow: 'quant' },
